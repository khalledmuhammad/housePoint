...
const Index = ({ data }) => {
  ...
  return (
    <>
  <Seo 
      pageTitle={ router.locale === "ar" ? `عقارات للبيع في القاهرة، مصر ${data?.length} | House Point ` :` ${data?.length}  Properties For sale In Cairo, Egypt | House Point` }
...
export async function getServerSideProps({ locale }) {
  const apiUrlEndpoint = `${process.env.NEXT_PUBLIC_API}/for-sale`;
